                    ...
                    auth.createUserWithEmailAndPassword(email,password).addOnCompleteListener(Sign_Up_Activity.this, new OnCompleteListener<AuthResult>() {
                        ...
                        public void onComplete(@NonNull Task<AuthResult> task) {
                            if (task.isSuccessful()){
                                Toast.makeText(Sign_Up_Activity.this, "User dengan email dan passwprd berhasil dibuat!", Toast.LENGTH_SHORT).show();
                            } else {
                                Toast.makeText(Sign_Up_Activity.this, "Otentikasi Gagal!", Toast.LENGTH_SHORT).show();
                            }
                        }
                    });
                }
